...
const token =
    '006bdb00e2957294e318f6e0fda5e9c0386IAApRc+c6H2iln97sllrtP9O1dREqFxNAsz1z35/TyGNh73zKVEAAAAAEAA3CeSjFVdUYgEAAQAVV1Ri';

class TalkRoomPage extends StatefulWidget {
  TalkRoomPage(
      {Key? key, required this.isBroadcaster, required this.channelName})
      : super(key: key);
...
class _TalkRoomPageState extends State<TalkRoomPage> {
  ...
  List<Widget> _getRenderViews() {
    ...
    _localUserJoined ? list.add(RtcLocalView.SurfaceView()) : null;
  ...
  void _onSwitchCamera() {
    ...
    if (streamId != null) _engine?.sendStreamMessage(streamId as int, bytes);
